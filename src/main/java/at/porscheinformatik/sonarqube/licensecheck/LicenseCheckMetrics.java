...
public class LicenseCheckMetrics implements Metrics
{
    ...
    public static final Metric DEPENDENCY =
        new Metric.Builder(DEPENDENCY_CHECK_DEPENDENCY_KEY, "License Check - Dependencies", Metric.ValueType.DATA)
    ...
    public static final Metric LICENSE =
        new Metric.Builder(DEPENDENCY_CHECK_LICENSE_KEY, "License Check - Licenses", Metric.ValueType.DATA)
