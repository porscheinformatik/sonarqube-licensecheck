...
class ScannerResolver
{
    ...
    static Scanner[] resolveScanners(Configuration configuration, File baseDir, MavenLicenseService mavenLicenseService,
        MavenDependencyService mavenDependencyService)
    {
        java.util.List<Scanner> scanners = new ArrayList<>();
