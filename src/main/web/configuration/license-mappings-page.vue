  ...
  <div class="boxed-group boxed-group-inner">
    <header class="page-header">
      ...
      <div class="page-actions">
        <button id="license-add" @click="showAddDialog()" class="button">
          Add License Mapping
        </button>
      </div>
    </header>
    ...
    <modal-dialog header="Delete Maven License" :show="!!itemToDelete" @close="cancelDelete()">
      <div slot="body" v-if="itemToDelete">
        Are you sure you want to delete the Maven license mapping &quot;{{
          itemToDelete.regex
