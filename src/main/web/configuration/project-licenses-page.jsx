...
const ProjectLicensesPage = () => {
  ...
  const saveItem = (item) => {
    if (editMode === 'add') {
      ...
      const itemToChange = newItems.find(i => 
        i.projectKey === item.projectKey && i.license === item.license
      );
  ...
  const deleteItem = (item) => {
    saveItems(
      items.filter(i => i.projectKey !== item.projectKey || i.license !== item.license)
    );
  };
    ...
    <div className="boxed-group boxed-group-inner">
      <header className="page-header">
        ...
        <div className="page-actions">
          <button className="button" id="license-add" onClick={showAddDialog}>Add License</button>
        </div>
      </header>
      ...
      >
        {itemToDelete && (
          <>
            <div>
              Are you sure you want to delete the license mapping "{findProjectName(itemToDelete.projectKey)}" / "{itemToDelete.license}"?
            </div>
            <div className="modal-foot">
