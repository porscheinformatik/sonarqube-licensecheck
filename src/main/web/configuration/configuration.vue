    ...
    <ul class="tabs">
      <li>
        <a
          ...
          :class="{ selected: currentRoute === 'licenses' }"
          @click="activateCategory($event, 'licenses')"
          >Licenses</a
        >
      </li>
      <li>
        <a
          ...
          :class="{ selected: currentRoute === 'license-mappings' }"
          @click="activateCategory($event, 'license-mappings')"
          >License Mappings</a
        >
      </li>
      <li>
        <a
          ...
          :class="{ selected: currentRoute === 'dependency-mappings' }"
          @click="activateCategory($event, 'dependency-mappings')"
          >Dependency Mappings</a
        >
      </li>
      <li>
        <a
          href="?category=project-licenses"
          :class="{ selected: currentRoute === 'project-licenses' }"
          @click="activateCategory($event, 'project-licenses')"
          >Project Licenses</a
        >
      </li>
    </ul>
    <br />
    <licenses-page v-if="currentRoute === 'licenses'"> </licenses-page>
    <dependency-mappings-page v-if="currentRoute === 'dependency-mappings'">
    </dependency-mappings-page>
    <license-mappings-page v-if="currentRoute === 'license-mappings'"> </license-mappings-page>
    <project-licenses-page v-if="currentRoute === 'project-licenses'"> </project-licenses-page>
  </div>
</template>
